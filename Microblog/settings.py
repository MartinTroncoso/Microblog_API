...
SECRET_KEY = 'django-insecure-tso9ktf&i961d-aw1#!ciip4-+rmpc6l3#9mk1!8t!mmub8i1k'
...
INSTALLED_APPS = [
    ...
    'Microblog_API.apps.Microblog_APIConfig',
    'rest_framework',
...
STATIC_URL = 'static/'
STATIC_FILES_DIRS = [
    os.path.join(BASE_DIR, 'Microblog_API/static')
]
